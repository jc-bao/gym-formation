...
def run(config):
    ...
    for ep_i in range(0, config.n_episodes, config.n_rollout_threads):
        ...
        maddpg.prep_rollouts(device='cpu') # gpu
...
if __name__ == '__main__':
    ...
    parser.add_argument("--n_rollout_threads", default=1, type=int) # 1
    parser.add_argument("--n_training_threads", default=6, type=int) # 6
