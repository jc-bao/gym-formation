...
def get_args():
    ...
    # Environment
    parser.add_argument("--scenario-name", type=str, default="formation_hd_env", help="name of the scenario script")
    parser.add_argument("--max-episode-len", type=int, default=30, help="maximum episode length")
    parser.add_argument("--time-steps", type=int, default=1000000, help="number of time steps") # 2000000
    ...
    # Checkpointing
    parser.add_argument("--save-dir", type=str, default="./model_3", help="directory in which training state and model should be saved")
    parser.add_argument("--save-rate", type=int, default=10000, help="save model once every time this many episodes are completed")
    parser.add_argument("--model-idx", type=int, default=1, help="The index of saved model to load")
