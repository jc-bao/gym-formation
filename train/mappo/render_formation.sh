...
do
    ...
    python render_formation.py --save_gifs --env_name ${env} --algorithm_name ${algo} --experiment_name ${exp} --scenario_name ${scenario} --num_agents ${num_agents} --seed ${seed} --n_training_threads 1 --n_rollout_threads 1 --use_render --episode_length 30 --render_episodes 5 --model_dir "./results/MPE/formation_hd_env/rmappo/check/run15/models"
done